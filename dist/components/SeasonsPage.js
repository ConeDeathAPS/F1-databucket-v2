...
function (_React$Component) {
  _inherits(SeasonsPage, _React$Component);

  function SeasonsPage(props) {
    var _this;

    _classCallCheck(this, SeasonsPage);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SeasonsPage).call(this, props));
    _this.state = {
      loadingState: false,
